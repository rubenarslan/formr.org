...
<ul class="nav nav-pills nav-stacked span6">
	...
	<li>
		<a href="<?=WEBROOT?>admin/<?=$study->name?>/show_results">Go back to results.</a>
	</li>
	<li class="nav-header">
		Export results as
	</li>
	<li>
		<a href="<?=WEBROOT?>admin/<?=$study->name?>/export_itemdisplay_tsv">TSV – tab-separated, human readable as plaintext</a>
	</li>
	<li>
		<a href="<?=WEBROOT?>admin/<?=$study->name?>/export_itemdisplay_xlsx">xlsX – new excel format, higher limits</a>
	</li>
