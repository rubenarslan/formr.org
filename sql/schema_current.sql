...
CREATE TABLE IF NOT EXISTS `formr`.`survey_studies` (
  ...
  `expire_after` INT UNSIGNED NULL DEFAULT NULL,
  `enable_instant_validation` TINYINT(1) NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `formr`.`survey_run_sessions` (
  ...
  `testing` TINYINT(1) NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `formr`.`survey_items_display` (
  ...
  `displaycount` SMALLINT UNSIGNED NULL DEFAULT NULL,
  `display_order` MEDIUMINT UNSIGNED NULL,
  `hidden` TINYINT(1) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `id_idx` (`item_id` ASC),
  UNIQUE INDEX `session_item_views` (`session_id` ASC, `item_id` ASC),
  INDEX `answered` (`session_id` ASC, `saved` ASC),
  CONSTRAINT `itemid`
    FOREIGN KEY (`item_id`)
...
-- -----------------------------------------------------
-- Table `formr`.`survey_text_messages`
-- -----------------------------------------------------
