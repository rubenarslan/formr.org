-- 063_unique_run_unit_iter.sql
-- Prevent duplicate unit-sessions forever (1.3.2 backport of the v0.27.0 fix, L2).
--
...
--
-- NOTE — this is the 1.x-line number. 063 is the next free slot here
-- (highest on disk was 062_unit_session_execution_time_index); the same migration is
-- 049 on the 0.26.x/0.27.0 line, whose 049 slot is a DIFFERENT (OAuth)
-- migration on this line — the cross-branch collision the repo warns about.
-- Reconcile against upstream sql/patches/ before release.
