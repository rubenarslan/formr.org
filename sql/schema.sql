...
--
-- Table structure for table `survey_cookies`
--

CREATE TABLE `survey_cookies` (
  `cookie` varchar(40) CHARACTER SET utf16 NOT NULL,
  `code` varchar(64) CHARACTER SET utf16 NOT NULL,
  `current_run` int(10) unsigned NOT NULL DEFAULT '0',
...
`id` int(11) unsigned NOT NULL,
  ...
  `choice_list` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `type_options` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 NOT NULL,
  `label` text CHARACTER SET utf8,
  `label_parsed` mediumtext CHARACTER SET utf8,
  `optional` tinyint(4) DEFAULT NULL,
  `class` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `showif` text CHARACTER SET utf8,
  `value` text COLLATE utf8_unicode_ci,
  `block_order` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `item_order` smallint(6) DEFAULT NULL,
  `order` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `post_process` text CHARACTER SET utf8,
...
`id` int(10) unsigned NOT NULL,
  ...
  `label_parsed` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `type` varchar(100) DEFAULT NULL,
  `type_options` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`id` int(10) unsigned NOT NULL,
  ...
  `cron_fork` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
`id` int(10) unsigned NOT NULL,
  ...
  `newsletter_verified` tinyint(1) DEFAULT NULL,
  `newsletter_verification_hash` varchar(255) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `survey_cookies`
--
ALTER TABLE `survey_cookies`
 ADD PRIMARY KEY (`cookie`), ADD UNIQUE KEY `code` (`code`);
...
ALTER TABLE `survey_items_display`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `session_item_views` (`session_id`,`item_id`), ADD KEY `id_idx` (`item_id`), ADD KEY `answered` (`session_id`), ADD KEY `page` (`page`);

--
-- Indexes for table `survey_item_choices`
--
ALTER TABLE `survey_item_choices`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_survey_item_choices_survey_studies1_idx` (`study_id`), ADD KEY `listname` (`list_name`), ADD KEY `list_name` (`list_name`);
...
ALTER TABLE `survey_studies`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `name_by_user` (`user_id`,`name`), ADD UNIQUE KEY `results_table_UNIQUE` (`results_table`), ADD KEY `fk_survey_studies_survey_users_idx` (`user_id`), ADD KEY `fk_survey_studies_run_items1_idx` (`id`);
