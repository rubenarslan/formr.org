...
//			$this->can_be_ended = $options['end'] ? 1:0;
	...
	public function displayForRun($prepend = '')
	{
		...
		<p><label>Text: <br>
			<textarea data-editor="markdown" style="width:350px" placeholder="You can use Markdown" name="body" rows="10" cols="60" class="form-control col-md-5">'.$this->body.'</textarea></label></p>';
