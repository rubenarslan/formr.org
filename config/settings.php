...
$settings['email'] = array(
	...
	'port' => 587,
	'tls' => true,
	'from' => 'no-reply@formr-cp.dev.idor.org',
	'from_name' => 'Formr CP',
	'username' => 'AKIAZWJQQE5ZP6LU75GM',
	'password' => 'BKuIs+fvmpthWGvsR68i2DdH98RKx5kdcaMM+dDom7tG',
...
$settings['display_errors_when_live'] = $_ENV['DEBUG_MODE'];
$settings['display_errors'] = $_ENV['DEBUG_MODE'];
$settings['error_to_stderr'] = 0;

// Timezone
$settings['timezone'] = $_ENV['TIMEZONE'];
...
$settings['define_root'] = array(
    'protocol' => 'https://',
    'doc_root' => $_ENV['MAIN_DOMAIN'] . '/',
    'study_domain' => $_ENV['MAIN_DOMAIN'] . '/',
