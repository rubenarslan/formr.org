...
<ul class="nav nav-tabs">
	<li class="active">
		<a href="<?=WEBROOT?>admin/survey/<?php echo $study->name; ?>/index"><?php echo _("Admin Area"); ?></a>
	</li>

	<li>
		<a href="<?=WEBROOT?>admin/survey/<?php echo $study->name; ?>/access"><?php echo _("Test study"); ?></a>
	</li>
	<li>
		<a href="<?=WEBROOT?>admin/"><?php echo _("Back to ACP"); ?></a>
	</li>
</ul>
...
<li>
	<li><a href="<?=WEBROOT?>admin/survey/<?=$study->name?>/edit_substitutions"><i class="icon-caret-right"></i> Edit substitutions</a>
</li>
