	...
	<div class="transparent_well col-md-12" style="padding-bottom: 20px;">
		<div class="row">
			<div class="col-md-12">
				...
				<h4><a href="<?= admin_study_url($study->name, 'show_results') ?>"><i class="fa fa-tasks fa-fw"></i> Go back to main results.</a></h4>
			</div>
		</div>
		<div class="col-md-12">
		...
		<?php if (count($results) > 0): ?>
			...
			<div class="row col-md-12">
				<form action="<?= admin_study_url($study_name, 'show_itemdisplay')?>" method="get" accept-charset="utf-8">
