...
class Autoload {
	...
	public static function classMap() {
		...
		return array(
			...
			'ApiHelper' => APPLICATION_PATH . 'Helper/ApiHelper.php',
			...
			'OAuthHelper' => APPLICATION_PATH . 'Helper/OAuthHelper.php',
			...
			'RunWorkerHelper' => APPLICATION_PATH . 'Helper/GearmanWorkerHelper.php',
