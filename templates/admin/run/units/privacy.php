...
<p>
    ...
    Set the privacy policy, terms of service and imprint in the run settings under Privacy.
...
<p>
    <label>Privacy Policy Consent Label (e.g. <code>I have read and accept the [Privacy Policy]({privacy-url})</code>): <br/>
    ...
    <label>Terms of Service Consent Label (e.g. <code>I have read and accept the [Terms of Service]({tos-url})</code>): <br/>
        <textarea data-editor="markdown" style="width:388px;" placeholder="You can use Markdown"
