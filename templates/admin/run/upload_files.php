                                    ...
                                    <?php foreach ($files as $row) { 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" data-url="<?php echo asset_url($row['new_file_path']); ?>" class="btn btn-sm btn-primary copy-url"><i class="fa fa-copy"></i> Copy URL</a>
                                                <a href="<?php echo admin_run_url($run->name, 'delete_file', array('file' => $row['original_file_name'], 'id' => $row['id'])); ?>" class="btn btn-sm btn-danger" data-confirm="Are you sure you want to delete this file?"><i class="fa fa-trash"></i> Delete File</a>	
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
