                        ...
                        <div class="col-md-12" style="margin: 10px;">
                            <form action="<?=site_url('admin/advanced/user_details')?>" method="get" class="form-inline">
                                ...
                                <div class="input-group" style="width: 350px;">
                                    ...
                                    <input name="session" value="<?= h(array_val($_GET, 'session')) ?>" type="text" class="form-control" placeholder="User code (starts with…)" title="Matches user/session codes that start with what you type (not a substring).">
                                </div>
                                    ...
                                    foreach ($users as $row) :
                                        ...
                                        <tr class="<?= $user_class . $continued ?>">
                                            ...
                                            <td>
                                                ...
                                                <small class="label <?=$label_class?> hastooltip" title="<?php echo h($row['result_log']); ?>"><?php echo h($row['result']);?></small>
                                            </td>
                                            <td>
