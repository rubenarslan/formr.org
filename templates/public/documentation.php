        ...
        <div class="row">
            ...
            <div class="col-md-10 documentation-content tab-content">
                <div id="get_started" class="tab-pane fade active in">
                    <?php Template::loadChild('public/documentation/getting_started'); ?>
                </div>
                ...
                <div class="tab-pane fade" id="available_items">
                    <?php Template::loadChild('public/documentation/item_types'); ?>
                </div>
                ...
                <div class="tab-pane fade" id="features">
                    <?php Template::loadChild('public/documentation/features'); ?>
                </div>
                <div class="tab-pane fade" id="api">
                    <?php Template::loadChild('public/documentation/api'); ?>
                </div>
                <div class="tab-pane fade" id="help">
                    <?php Template::loadChild('public/documentation/get_help'); ?>
                </div>
            </div>
        </div>
    </div>
