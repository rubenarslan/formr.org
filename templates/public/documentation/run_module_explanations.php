    ...
    <div class="panel panel-default">
        ...
        <div id="push_notification" class="panel-collapse collapse push_notification">
            <div class="panel-body">
                ...
                <p>
                    Once your study has a manifest, you can add special items (see App section of <a href="<?= site_url('documentation#available_items') ?>">available items</a>) like <code>add_to_homescreen</code> to your surveys. This will add a button to the participant's device that allows them to add your study to their homescreen. <code>request_phone</code> will guide the user to switch to a mobile device. And <code>push_notification</code> will ask the user to allow push notifications for your study.
                </p>
                <p>
